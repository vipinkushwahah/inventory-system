...
// export default function TakeProduct({ products, fetchProducts }) {
...
//             {p.name} (Available: {p.availableStock})
//           </option>
//         ))}
//       </select> */}
//       <select value={productId} onChange={e => setProductId(e.target.value)}>
...
//       <input value={name} onChange={e => setName(e.target.value)} placeholder="Taken By" />
